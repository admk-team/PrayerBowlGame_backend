...
@section('title', 'Admin | Prayer Request Categories')
                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Prayer Request Categories</h4>
                                <a href="{{ route('reqcategory.create') }}" class="btn btn-primary btn-sm float-right">Add
                                    Category</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-bottom-0">
                                                    <a href="{{ route('reqcategory.edit', $item->id) }}" class="btn btn-sm">
                                                        <i class="edit ri-pencil-line text-info m-2"></i>
                                                    </a>
                                                    <form action="{{ route('reqcategory.destroy', $item->id) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
